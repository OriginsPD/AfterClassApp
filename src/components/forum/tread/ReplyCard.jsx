									...
									<img
										...
										src={
											innVal.user.username
												? `https://ui-avatars.com/api/?background=random&color=fff&name=${innVal.user.username}`
									...
									<div className="flex-1 space-y-1">
										<div className="mb-2 flex items-center justify-between">
											<h3 className="text-lg font-medium">
												<strong>{innVal.user.username}</strong>
											</h3>
										...
										<p className="text-sm text-gray-800">{innVal.content}</p>
									</div>
								</div>
